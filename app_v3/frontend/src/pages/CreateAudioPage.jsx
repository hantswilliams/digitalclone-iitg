...
const CreateAudioPage = () => {
  ...
  const handleGenerateScript = async () => {
    ...
    try {
      ...
      const response = await generationService.generateScript({
        prompt: textInput,
        length: 'medium', // Can be made configurable
        style: 'educational' // Can be made configurable
      });

      if (response.script) {
        setTextInput(response.script);
  ...
  const handleGenerateAudio = async () => {
    ...
    try {
      ...
      // First, upload the audio file as an asset
      ...
      console.log('✅ Voice sample uploaded:', assetResponse.asset.id);
      
      // Create a job for TTS generation with the uploaded asset
      const jobData = {
        ...
        parameters: {
          text: textInput,
          voice_asset_id: assetResponse.asset.id
        },
        priority: 'normal',
        asset_ids: [assetResponse.asset.id]
      };
    ...
    <div className="max-w-4xl mx-auto p-6">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-1 text-sm text-blue-700">
                      This audio will be used to clone the speaker's voice for your text-to-speech generation.
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="mt-8 flex justify-center">
        <button
          ...
          disabled={isGeneratingAudio || !textInput.trim() || !audioFile}
